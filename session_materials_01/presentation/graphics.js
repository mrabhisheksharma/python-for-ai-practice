...
,
    ...
    'conc-1': {
        ...
        right: `<svg viewBox="0 0 280 300" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="140" y="30" class="title" text-anchor="middle">Technical: Threads</text>
            <rect x="20" y="60" width="240" height="100" class="bg" />
            <text x="40" y="90" class="code">import threading</text>
            <text x="40" y="120" class="code">t.start()</text>
            <text x="140" y="220" class="text" text-anchor="middle" fill="#0ea5e9">Great for I/O bound</text>
            <text x="140" y="240" class="text" text-anchor="middle" fill="#0ea5e9">API calls & Network tasks</text>
        </svg>`
    },
    'conc-2': {
        left: `<img src="assets/concurrency_office.jpg" alt="Real World Metaphor" style="width:100%; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.3); border: 2px solid var(--border);">`,
